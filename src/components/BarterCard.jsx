...
export default function BarterCard({ offer, index = 0, exitIndex = 0, shouldExit = false, onAnimationComplete, onExitClick }) {
  ...
  const handleClick = () => {
    if (!shouldExit && onExitClick) {
      onExitClick(offer.id);
    }
  };
