    ...
    <>
      ...
      <div className="px-4 md:px-8 pb-4 md:pb-5 pt-3 md:pt-4 flex items-center justify-end gap-3">
        ...
        <button
          ...
          className={`flex-1 text-white text-sm font-black py-2.5 md:py-3 px-4 rounded transition-colors disabled:bg-gray-400 dark:disabled:bg-gray-800 dark:disabled:text-gray-600 disabled:cursor-not-allowed flex items-center justify-center gap-2 ${
            offerMode === 'pick_drop'
